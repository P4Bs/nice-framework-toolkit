class RoleCost:
    ...
    def init_parameters_args(self, role_id: str, name: str = "", category: str = "", training_cost = 0, outsourcing_cost = 0, time_to_hire_months = 0.0, bonus_cost = 0, criticality_score = 0.0, risk_impact_score = 0.0):
